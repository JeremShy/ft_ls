...
/*   Updated: 2016/03/08 16:02:51 by jcamhi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int						list_folder(t_opt options,
							char *dir, char *name_pr, char *lnk);
...
t_file					*create_dir_list(t_opt options,
							int start, char **av, int ac);
...
void					sort_n_print(t_file *list,
							t_opt options, int print_total, char *dir);
t_file					*create_printable_list(char
							*lnk, t_file *list, DIR *directory, t_opt options);
int						check_error(DIR *directory, char *name_pr, char *dir);
t_file					*folder_is_file(char *lnk, char *dir,
							int *print_total, int *is_file);
void					while_main(t_file *list,
							int ac, int start, t_opt options);
t_file					*create_2(t_file *ret, t_stat structure,
							char *name, char *path);
...
void					add_list_with_name(t_file
							*list, char *name, char *path, int size);
t_opt					init_opt(void);
